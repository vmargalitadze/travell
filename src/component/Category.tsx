...
const Category = () => {
    ...
    const filterUpcomingNearestPackages = (allPackages: Package[]): Package[] => {
        ...
        const countries = [...new Set(upcomingPackages.map(pkg => pkg.location?.country).filter(Boolean))];
                        ...
                        <div className="mt-20">
                            <div className="mb-8 text-center">
                                ...
                                <p className="text-lg font-[Quicksand,sans-serif] font-medium leading-snug mb-6">
                                    {t("upcomingTripsSubtitle") || "Discover upcoming adventures near you, sorted by nearest location"}
                                </p>
                            </div>
                                            ...
                                            <div className="p-3 flex flex-col flex-1 font-[Quicksand,sans-serif]">
                                                <div className="flex flex-col h-full">
                                                    ...
                                                    {(() => {
                                                        ...
                                                        if (earliestDate) {
                                                            return (
                                                                <div className="flex items-center text-sm text-[#EA8F03] mb-4">
                                                    ...
                                                    <div className="flex items-center justify-between mt-auto">
                                                        ...
                                                        <Link
                                                            ...
                                                            className="text-[16px] font-bold bg-[#51a9ff] cursor-pointer text-white py-2 px-4 rounded-lg transition-colors hover:bg-[#3a8ce6]"
                                                        >
                                                            {t("viewDetails")}
                                                        </Link>
                                                    </div>
